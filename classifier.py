...
sample_size = 17760 # 500
cars = cars[0:sample_size]
notcars = notcars[0:sample_size]

### TODO: Tweak these parameters and see how the results change.
colorspace = 'LUV' # Can be RGB(0.9338), HSV(0.9074), LUV(0.9538), HLS(0.9091), YUV(0.9457), YCrCb(0.9465)
orient = 9
pix_per_cell = 8
cell_per_block = 2
hog_channel = 0 # Can be 0, 1, 2, or "ALL" LUV,0:0.949
